...
<body class="corp">
                ...
                <section>
                    <h3 class="text-primary" style="text-align: center; margin-top: 20px;">Contactez-nous</h3>
                    <div class="container">
                      <form action="">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="" style="text-align:center;">
                              <input type="submit" value="envoyer" class="btn btn-secondary mt-5 bou">
                            </div>
                          </div>
                         <!-- <div class="col-md-2">
                            <div class="bouton" style="text-align:center;">
                              <input type="reset" value="annuler" class="btn btn-secondary mt-5">
                            </div>
                          </div>-->
                        </div>
